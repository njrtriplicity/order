package com.cb.viooh.order.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).directModelSubstitute(XMLGregorianCalendar.class, Date.class)
				...
				.apis(RequestHandlerSelectors.basePackage("com.cb.viooh.order")).paths(PathSelectors.any())
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("NJR Order")
